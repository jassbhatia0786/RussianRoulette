...
namespace RussianRoulette1
{
    public partial class RussianRoulette : Form
    {
        ...
        private void btn_Spin_Click(object sender, EventArgs e)
        {
            ...
            SoundPlayer audio = new SoundPlayer(RussianRoulette1.Properties.Resources.spin); 
            audio.Play();
        ...
        private void btn_Shoot_Click(object sender, EventArgs e)
        {
            ...
            //code to play sound on button click 
            SoundPlayer audio = new SoundPlayer(RussianRoulette1.Properties.Resources.fire);
            audio.Play();
